...
public class GlobalValues
{
    ...
    static public   String  scalalabBuildVersion = "25-May-15";    
...
// variables for ScalaLab - MatLab interface
   ...
   static public boolean completionIsForSyntaxPane = true; //  the jsyntaxpane or the rsyntaxarea editor triggered the completion
   ...
   static public int maxItemsToDisplayAtCompletions = 15;
    ...
    static public Boolean  compilerOptimizationFlag = false;  // controls whether to optimize the code
...
// accessing values for variables of all types vs. the normal behaving ones (i.e. primitive types and scalaSci types)
    ...
    // keeps the names of the toolboxes, the contents of shich are currently displayed
 ...
 //   the next two fields are used to instantiate dynamically vectors and matrices from string representations, e.g. to create a matrix with with M("0.9 -0.43455; -1.2 0.4")    
    ...
    static public String  editingFileInPane = null;
    ...
    static public JEditorPane editorPane;
    static public RSyntaxTextArea globalRSyntaxEditorPane;
    
    
     public static  scala.tools.nsc.interpreter.IMain  globalInterpreter;   // the main interpreter
     public static  scala.tools.nsc.interpreter.IMain  cellsInterpreter;    // the Interpreter used to execute code in ScalaCodeCells
...
//                    "import org.apache.commons.math.complex._ \n"+
 ...
 // This directory and all its subdirectories are searched for both .Scala script files and .class files        
   ...
   // these toolboxes can then be automatically reloaded
    ...
    static {  // Windows and Linux support also GSL and JavaFX
