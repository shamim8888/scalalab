...
{
        JLineCompletion cmp = new JLineCompletion(GlobalValues.globalInterpreter);
        scala.tools.nsc.interpreter.Completion.ScalaCompleter  completer = cmp.completer(); // the completer class of the Scala Interpreter on which some completion services are based
